...
\begin{enumerate}
    \item \textbf{Solution}. 设$x_{n}=\frac{1}{n^{2}+n+1}+\frac{2}{n^{2}+n+2}+\cdots
          ...
          \[
              \begin{gathered}
                  \lim_{n\to\infty}\frac{1+2+\cdots+n}{n^{2}+n+n}=\lim_{n\to\infty}\frac{n(n+1)}{2(n^{2}+2n)}
                  =\frac{1}{2}, \\
    ...
    \item \textbf{Solution}. 因为$y=\frac{1}{2}\left[\ln\frac{2}{\pi}+\ln\arctan\frac{1}{x}
                  \right]$，所以
          \[
              \begin{aligned}
    ...
    \item \textbf{Solution}.
          \[
              \frac{\mathrm{d}y}{\mathrm{d}x}=\frac{x\cos x-\sin x}{x^{2}},
          \]
          \[
    ...
    \item \textbf{Solution}. 因为$y=\frac{1}{x-1}-\frac{2}{2x-1}$，所以
          \[
              \begin{aligned}
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. 在方程$y=\sin(x+y)$两边对$x$求导得
          ...
          解得
          \[
              \frac{\mathrm{d}^{2}y}{\mathrm{d}x^{2}}=\frac{-\sin(x+y)(1+y')^{2}}{1-\cos(x+y)}
