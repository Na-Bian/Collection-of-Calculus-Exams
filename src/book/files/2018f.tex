...
\begin{enumerate}
    ...
    \item 设函数$f(x)$在$x=a$处可导，则函数$\sqrt[3]{f(x)}$在$x=a$处（\qquad）.
    ...
    \item 设函数$f(x)$在区间$(a,b)$内连续，则$f(x)$在区间$(a,b)$内（\qquad）.
    ...
    \item 设函数$f(x)$在区间$(a,b)$内满足$f'(x)<0$，$f''(x)>0$，则在区间$(a,b)$内（\qquad）.
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. C.
          ...
          由题意可知$\lim_{x\to a}\frac{f(x)-f(a)}{x-a}$存在，所以
          \[
              \lim_{x\to a}\left
              (f(x)-f(a)\right)=\lim_{x\to a}\frac{f(x)-f(a)}{x-a}\cdot \lim_{x\to a}(x-a
              )=0,
          \]
          即$\lim_{x\to a}f(x)=f(a)$，所以
          \[
              \lim_{x\to a}\sqrt[3]{f(x)}=\sqrt[3]{\lim_{x\to
                      a}f(x)}=\sqrt[3]{f(a)},
          \]
          故函数$\sqrt[3]{f(x)}$在$x=a$处连续. 考虑$f(x)=x$，$a=0$，则$\sqrt[3]{f(x)}=\sqrt[3]{x}$在$x=0$处不可导，

          所以$\sqrt[3]{f(x)}$在$x=a$处连续但不一定可导.
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. $a=1$，$b=\frac{1}{6}$.
          ...
          \[
              \begin{aligned}
                  u = {} & x+a\ln(1-x)+bx\sin(3x)                                                            \\
                  = {}   & x-a\left(x+\frac{x^2}{2}+\frac{x^3}{3}+o(x^{3})\right)+bx\left(3x+o(x^{2})\right) \\
    ...
    \item \textbf{Solution}. $(2,-3)$.
          ...
          计算
          \[
              y'=3x^{2}-12x+5,\quad y''=6x-12,
          \]
          令$y''=0$得$x=2$，且当$x<2$时，$y''<0$，当$x>2$时，$y''>0$，
    ...
    \item \textbf{Solution}. $12$.
          ...
          故
          \[
              s=3\int_{0}^{2\pi}|\sin 2t|\mathrm{d}t=6\int_{0}^{\pi}|\sin u|\mathrm{d}
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. 令$u=\sqrt{x-3}$，则$x=t^{2}+3$，$\mathrm{d}x=2
          ...
          \[
              \begin{aligned}
                  ...
                  = {}   & u-3\cdot\frac{1}{\sqrt{3}}\arctan\frac{u}{\sqrt{3}}+ C                                 \\
                  = {}   & \sqrt{x-3}-\sqrt{3}\arctan\sqrt{\frac{x-3}{3}}+C.
              \end{aligned}
          \]
    ...
    \item \textbf{Solution}. 记$J = \int \mathrm{e}^{-2x}\sin x\,\mathrm{d}x$，则
          \[
              \begin{aligned}
                  J = {} & -\int \mathrm{e}^{-2x}\,\mathrm{d}\cos x                                                      \\
                  = {}   & -\mathrm{e}^{-2x}\cos x - 2\int \mathrm{e}^{-2x}\cos x\,\mathrm{d}x                           \\
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. 当$x\in(-1,0)\cup(0,+\infty)$时，$\ln f(x) = \frac{\ln(1+x)}{x}$，
          ...
          所以
          \[
              f'(x)=f(x)\cdot \frac{\frac{x}{1+x}-\ln(1+x)}{x^{2}}=(1+x)^{\frac{1}{x}}
    ...
    \item \textbf{Solution}.旋转体的体积
          \[
              \begin{aligned}
                  V= {} & \int_{0}^{\frac{\pi}{2}}2\pi x f(x)\,\mathrm{d}x = 2\pi\int_{0}^{\frac{\pi}{2}}x\cos x\,\mathrm{d}x                                              \\
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. 令$F(t)=\int_{a}^{t}f(x)\,\mathrm{d}x-\frac{(t-a)(f(a)+f(t))}{2}
          ...
          则
          \[
              F'(t)=f(t)-\frac{f(a)+f(t)+(t-a)f'(t)}{2},
          \]
          \[
              F''(t)=f'(t)-\frac{1}{2}f'(t)-\frac{1}{2}\left[f'(t)+(t-a)f''(t)\right]=-\frac{1}{2}
              (t-a)f''(t)\geq 0.
          \]
          所以$F'(t)$在$[a,+\infty)$上单调递增，$F'(t)\geq F'(a)=0$， 因此
          \[
              \int_{a}^{b}f(x)\,\mathrm{d}x \geq \frac{(b-a)(f(a)+f(b))}{2}.
          \]
\end{enumerate}
