...
\begin{enumerate}
    ...
    \item \textbf{Solution}. D.
          ...
          当$x\to+\infty$时，
          \[
              \lim_{x\to+\infty}\frac{\frac{1}{x}+\ln\left(1+\mathrm{e}^{x}\right)}{x}
          ...
          \[
              \lim_{x\to-\infty}\frac{\frac{1}{x}+\ln\left(1+\mathrm{e}^{x}\right)}{x}
              =0,\quad\lim_{x\to-\infty}\left[\frac{1}{x}+\ln\left(1+\mathrm{e}^{x}\right)\right
              ]=0,
          \]
          所以曲线$y=\frac{1}{x}+\ln\left(1+\mathrm{e}^{x}\right)$有水平渐近线$y=0$.

          故曲线$y=\frac{1}{x}+\ln\left(1+\mathrm{e}^{x}\right)$的渐近线条数为$3$.
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. 计算$f'(x)=3x^{2}-6x-9$，令$f'(x)=0$得到函数在$(-2,
              2)$内的驻点为$x=-1$.

          比较
          \[
              f(-2)=3,\quad f(-1)=10,\quad f(2)=-17,
          \]
          所以函数在区间$[-2,2]$上的最大值为$10$，最小值为$-17$.
    ...
    \item \textbf{Solution}.
          \[
              \begin{aligned}
                  I = {} & \int_{0}^{\frac{\pi}{4}}x\,\mathrm{d}\tan x                                           \\
                  = {}   & x\tan x\bigg|_{0}^{\frac{\pi}{4}}-\int_{0}^{\frac{\pi}{4}}\tan x\,\mathrm{d}x         \\
                  = {}   & \frac{\pi}{4}+\ln|\cos x|\bigg|_{0}^{\frac{\pi}{4}} = \frac{\pi}{4}-\frac{1}{2}\ln 2.
              \end{aligned}
          \]
    ...
    \item \textbf{Solution}. 令$x=\tan t$，则$\mathrm{d}x=\sec^{2} t\,\mathrm{d}
          ...
          \[
              \begin{aligned}
                  \int_{0}^{1}\frac{1}{x\sqrt{x^2+1}}\,\mathrm{d}x = {} & \int_{0}^{\frac{\pi}{4}}\frac{\sec^2 t}{\tan t\sqrt{\tan^2 t+1}}\,\mathrm{d}t                  \\
                  = {}                                                  & \int_{0}^{\frac{\pi}{4}}\csc t\,\mathrm{d}t =  -\ln|\csc t+\cot t|\bigg|_{0^+}^{\frac{\pi}{4}} \\
                  = {}                                                  & -\ln(\sqrt{2}+1)+\lim_{t\to0^+}\ln\frac{1+\cos t}{\sin t}                                      \\
                  = {}                                                  & +\infty.
              \end{aligned}
          \]
    ...
    \item \textbf{Solution}. 令$y'=p$，则$y''=\frac{\mathrm{d}p}{\mathrm{d}x}
          ...
          微分方程$y''=\frac{\sin y}{\cos^{3} y}$变形为
          \[
              p\,\mathrm{d}p=\frac{\sin y}{\cos^{3}y}\,\mathrm{d}y.
          \]
...
\begin{enumerate}
    \setcounter{enumi}{16}
    \item \textbf{Solution}. 当$x\in(-1,0)\cup(0,+\infty)$时，
          \[
              f'(x)=\frac{\frac{x}{1+x}-\ln(1+x)}{x^{2}}=\frac{x-(1+x)\ln(1+x)}{x^{2}(1+x)}.
          \]
          当$x=0$时，
          \[
              f'(0)=\lim_{x\to0}\frac{f(x)-f(0)}{x}=\lim_{x\to0}\frac{\ln(1+x)-x}{x^{2}}
              =-\frac{1}{2}.
          \]
          又
          \[
              \begin{aligned}
                  \lim_{x\to0}f'(x) = {} & \lim_{x\to0}\frac{x-(1+x)\ln(1+x)}{x^{2}(1+x)} = \lim_{x\to0}\frac{x-(1+x)\ln(1+x)}{x^{2}} \\
                  = {}                   & \lim_{x\to0}\frac{1-\ln(1+x)-1}{2x} = -\frac{1}{2} = f'(0).
              \end{aligned}
          \]
          所以$f'(x)$在点$x=0$处连续.

    \item \textbf{Solution}.因为$y'=\frac{1}{2\sqrt{x}}-\frac{\sqrt{x}}{2}$，所以
          \[
              \mathrm{d}s=\sqrt{1+y'^{2}}\,\mathrm{d}x=\sqrt{1+\frac{1}{4x}+\frac{x}{4}-\frac{1}{2}}
              \mathrm{d}x=\sqrt{\left(\frac{1}{2\sqrt{x}}+\frac{\sqrt{x}}{2}\right)^{2}}\,\mathrm{d}
              x=\frac{1}{2}\left(\frac{1}{\sqrt{x}}+\sqrt{x}\right)\,\mathrm{d}x.
          \]
          故
          \[
              s=\frac{1}{2}\int_{1}^{4}\left(\frac{1}{\sqrt{x}}+\sqrt{x}\right)\,\mathrm{d}
