...
\begin{enumerate}
    ...
    \item \textbf{Solution}. D.
          ...
          \[
              ...
              \end{cases},
          \]
          其中$k$是正整数. 则$x_{n} y_{n}\equiv0$，但$x_{n}$，$y_{n}$均无界，且$\lim_{n\to\infty}x_{n}$，$\lim
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. $3$.
          ...
          当$x\to0$时，
          \[
              \left(1+x\right)^{x^2}-1 = \mathrm{e}^{x^2\ln(1+x)}-1 = \mathrm{e}
    ...
    \item \textbf{Solution}. $\ln\left(1+\sqrt{2}\right)$.
          ...
          故
          \[
              s=\int_{0}^{\frac{\pi}{4}}\sec x\,\mathrm{d}x=\ln\left|\sec x+\tan x\right
...
\begin{enumerate}
    \setcounter{enumi}{10}
    \item \textbf{Solution}. 曲线$C$没有竖直渐近线和水平渐近线. 计算
          \[
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. $f'(x)=\sqrt{1+x^{2}}-2x\sqrt{1+x^{2}}=(1-2x)\sqrt{1+x^{2}}$，
          ...
          因为
          \[
              f(0)=\int_{1}^{0}\sqrt{1+t^{2}}\,\mathrm{d}t+\int_{0}^{1}\sqrt{1+t}\,\mathrm{d}
              t=\int_{0}^{1}\left(\sqrt{1+t}-\sqrt{1+t^{2}}\right)\,\mathrm{d}t>0,
          \]
          \[
              f(1)=0,\quad f(-1)=\int_{1}^{-1}\sqrt{1+t^{2}}\,\mathrm{d}t<0,
          \]
          故方程$f(x)=0$有两个实根.
    ...
    \item \textbf{Solution}. 令$t-x=u$，则$\int_{-x}^{0}f(u)\,\mathrm{d}u=-\frac{x^{3}}{3}
          ...
          \[
              \begin{aligned}
                  V= {} & \int_{0}^{2}2\pi xf(x)\,\mathrm{d}x = 2\pi\int_{0}^{2}x(-x^{2}+2x)\,\mathrm{d}x \\
                  = {}  & 2\pi\int_{0}^{2}(-x^{3}+2x^{2})\,\mathrm{d}x                                    \\
...
\begin{enumerate}
    ...
    \item \textbf{Proof}. 由Taylor公式，将$f(x)$分别在$x=0$和$x=2$处展开得
          ...
          \]
          取$|f''(\xi)|=\max\{|f''(\eta)|,|f''(\zeta)|\}$，则
          \[
              |f(2)-f(0)|\leq\frac{1}{2}|f''(\xi)|\left[(x-2)^{2}+x^{2}\right]\leq \frac{1}{2}
              |f''(\xi)|\cdot 2=|f''(\xi)|,
          \]
          即$|f''(\xi)|\geq|f(2)-f(0)|$.
\end{enumerate}
