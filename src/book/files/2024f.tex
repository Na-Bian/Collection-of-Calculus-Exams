...
\begin{enumerate}
    \item 当$x\to0$时，函数$f(x)=\frac{1}{x}\sin\frac{1}{x}$是（\qquad）.
    ...
    \item 设$\{a_{n}\},\{b_{n}\},\{c_{n}\}$均为非负数列，且$\lim_{n\to\infty}a_{n}
              =0$，$\lim_{n\to\infty}b_{n}=1$，$\lim_{n\to\infty}c_{n}=+\infty$，则（\qquad）.
    ...
    \item 设函数$f(x)$满足$f'(x_{0})=f''(x_{0})=0$，且$f'''(x_{0})>0$，则（\qquad）.
    ...
    \item 若$f'(2x)=\mathrm{e}^{-x}$，且$f(0)=1$，则$\int f(x)\,\mathrm{d}x=$（\qquad）.
    ...
    \item 设函数$f(x)$二阶可导，且$f''(x)<0$，$f(0)=0$，则（\qquad）.
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. $1$.
          ...
          计算$\frac{\mathrm{d}y}{\mathrm{d}x}=\frac{\frac{\mathrm{d}y}{\mathrm{d}t}}{\frac{\mathrm{d}x}{\mathrm{d}t}}
              =\frac{4-2t}{2t}=\frac{2-t}{t}$，当$x=2$时，$t=1$，$y=f(2)=3$，故$f'(2)=\left
              .\frac{\mathrm{d}y}{\mathrm{d}x}\right|_{t=1}=1$.

          从而
          \[
              \lim_{n\to\infty}n\left[f\left(\frac{2n+1}{n}\right)-3\right]=\lim_{n\to\infty}
    ...
    \item \textbf{Solution}. $\frac{\pi}{4-\pi}$.
          ...
          设$\int_{0}^{1} f(x)\,\mathrm{d}x=C$，则$f(x)=\frac{1}{1+x^{2}}+C\sqrt{1-x^{2}}$. 方程两边从$0$积分到$1$，得
          \[
              C=\int_{0}^{1}\frac{1}{1+x^{2}}\,\mathrm{d}x+C\int_{0}
              ^{1}\sqrt{1-x^{2}}\,\mathrm{d}x=\frac{\pi}{4}+\frac{\pi}{4}C,
          \]
          解得$C=\frac{\pi}{4-\pi}$.
...
\begin{enumerate}
    ...
    \item \textbf{Solution}. 当$x=0$时，$F(0)=0$.
          ...
          当$x\neq 0$时，
          \[
              F'(x)=\frac{xf(x)-\displaystyle\int_{0}^{x}f(u)\,\mathrm{d}u}{x^{2}},\quad F
