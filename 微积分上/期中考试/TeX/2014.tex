...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \item[12.] 设函数$f(x)$在$x=0$处二阶可导.$f'(0)=0,f''(0)=2$.求$l=\lim_{x\to0}
      \frac{f(\tan x)-f(x)}{x^{4}}$.
      \vspace{12em}
  ...
  \begin{enumerate}
    \item[15.] 设函数$f(x),g(x)$在$[a,b]$上连续，在$(a,b)$内可导，证明存在$\xi\in
      (a,b)$，使得$\frac{f'(\xi)}{g'(\xi)}=\frac{f(\xi)-f(a)}{g(b)-g(\xi)}$.
      \vspace{12em}

    \item[16.] 设函数$f(x)=\alpha_{1}\varphi(x)+\alpha_{2}\varphi(2x)+\cdots+\alpha
  ...
  \section{综合题(每小题 7 分，共 28 分)}
  \begin{enumerate}
    \item[11.] \textbf{Solution}. $\lim_{x\to 0^+}f(x)=\lim_{x\to 0^+}\frac{\cos
      x}{x+2}=\frac{1}{2}$.
    ...
    \item[13.] \textbf{Solution}. $g'(x)=f'(x)\sin^{2} x+f(x)\cdot 2\sin x\cos x$，所以$g
      '(0)=0$.
      \[
        \begin{aligned}
    ...
    \item[14.] \textbf{Solution}. 设$t$时刻梯子底端的地面长度为$x(t)$英尺，梯子顶端距地面的距离为$y
      (t)$英尺，
  ...
  \section{证明题(每小题 6 分，共 12 分)}
  \begin{enumerate}
    \item[15.] \textbf{Proof}. 令$F(x)=f(x)g(x)-f(x)g(b)-f(a)g(x)$，则函数$F(x)$在$[
      a,b]$上连续，在$(a,b)$内可导，
    ...
    \item[16.] \textbf{Proof}. $f(0)=\alpha_{1}\varphi(0)+\alpha_{2}\varphi(0)+\cdots
      +\alpha_{n}\varphi(0)=0$.
      \[
        \begin{aligned}
