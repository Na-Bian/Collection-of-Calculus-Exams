...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Solution}. $l=\lim_{x\to0}\mathrm{e}^{\frac{1}{\mathrm{e}^{x}-1}\ln\frac{\ln(1+x)}{x}}
      =\mathrm{e}^{\lim\limits_{x\to0}\frac{1}{\mathrm{e}^{x}-1}\ln\frac{\ln(1+x)}{x}}$.
    ...
    \item \textbf{Solution}. $f(x)$的间断点为$x=k\pi$，$x=k\pi+\frac{\pi}{2}$，$k
      ...
      $x=0$是跳跃间断点.因为
      \[
        \lim_{x\to0^+}\mathrm{e}^{\frac{|x|}{\tan x}}=\mathrm{e}^{\lim\limits_{x\to0^+}\frac{x}{\tan
  ...
  \begin{enumerate}
    ...
    \item \textbf{Solution}. 原方程变为$\mathrm{e}^{xy}(y+xy')+\frac{y'}{y}-
      \frac{1}{x+1}=0$，
